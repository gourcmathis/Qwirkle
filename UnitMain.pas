...
function mettrepion(pioche:pointPioche; liste:pointPioche;nb:integer):pointPioche;
...
res.nbpiece:=i-1;//le nombre de pion dans la liste
renvoyerpion:=res;
end;
